...
const APK_SIGNING_BLOCK_MAGIC = process.env.APK_SIGNING_BLOCK_MAGIC || 'APK Sig Block 42';
const APK_MAGIC_SIZE = 16;
const APK_BLOCK_SIZE_OFFSET = 24;
const CUSTOM_PAIR_ID = process.env.APK_CUSTOM_PAIR_ID ? parseInt(process.env.APK_CUSTOM_PAIR_ID) : 0x71717171;
